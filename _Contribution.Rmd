...
### Modify your page
 ...
 2- Create a branch to work on for your page, so you can work on it before it appears online ([see section 2.4.2 here for help](https://aberdeenstudygroup.github.io/studyGroup/lessons/SG-T1-GitHubVersionControl/VersionControl/#2.3.)). **Please, name the branch the same name as your page.**
 ...
 6- When your page is ready to be published online or has new modifications that you want to appear online, ask for merging your branch with the master branch using pull request. ([see section 2.4.4 here for help](https://aberdeenstudygroup.github.io/studyGroup/lessons/SG-T1-GitHubVersionControl/VersionControl/#2.3.))
 
 7- Do not delete your branch as it will be used by others to suggest modifications/new resources on your page
