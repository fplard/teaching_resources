...
|**Multivariate Analysis of Ecological Communities in R: vegan tutorial** *J. Oksanen* -- demostrates the use of ordination methods in Rpackage vegan, assumes familiarity both with R andwith community ordination |`r ilink("tuto", "https://www.mooreecology.com/uploads/2/4/2/1/24213970/vegantutor.pdf", lvl=2)`|
