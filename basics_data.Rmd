...
|**Data visualization** *A Heiss* -- Interactive lessons for data visualization with R|`r ilink("tuto", "https://datavizm20.classes.andrewheiss.com/syllabus/#course-materials", lvl=1)`|

### Interactive Applications & Plots

| Name                                      | Links |
|-------------------------------------------|-------|
|**Interactive charts** *Y Holtz* -- Create interactive charts in R|`r ilink("tuto", "https://r-graph-gallery.com/interactive-charts.html", lvl=2)`|
