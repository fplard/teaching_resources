...
|**Statistics for Ecologists** *J Fieberg* -- An open-source textbook covering a variety of regression methods in both Bayesian and frequentist frameworks|`r ilink("tuto", "https://fw8051statistics4ecologists.netlify.app/", lvl=1)`|
|**Statistical Methods Seminar Series** -- Seminars on different statistical methods|`r ilink("video", "https://ecoforecast.org/workshops/statistical-methods-seminar-series/", lvl=2)`|
...
|**Structural equation modeling** *J Lefcheck* -- Familiarize with the philosophy and practice of structural equation modeling|`r ilink("course", "https://jonlefcheck.net/teaching/", lvl=1)`|
