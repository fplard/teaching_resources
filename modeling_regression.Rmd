...
|**Statistical Thinking for the 21st Century** *R A Poldrack* -- focuses on understanding the basic ideas of statistical thinking, about how we describe the world and use data make decisions and predictions, in the context of the inherent uncertainty that exists in the real world|`r ilink("site", "https://statsthinking21.github.io/statsthinking21-core-site/index.html", lvl=2)`|
|**Michael Clark site** -- A series of open introductory workshop in bayesian analysis, mixed models, GAM, SEM and machine learning |`r ilink("site", "https://m-clark.github.io/documents.html", lvl=1)`|
...
| Name                                      | Links |
|-------------------------------------------|-------|
|**Regression Methods** *I Pardoe from Penn State College* -- a full course on Linear regression, also introducing Generalized linear regression|`r ilink("tuto", "https://online.stat.psu.edu/stat501/", lvl=1)`|
...
| Name                                      | Links |
|-------------------------------------------|-------|
|**GLMM course** *S. Anderson*-- a 2 day workshop including a full introduction: regression, random intercepts and slopes, spatial and temporal autocorrelation, including practical|`r ilink("tuto", "https://github.com/seananderson/glmm-course", lvl=1)`|
