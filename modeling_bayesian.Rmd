...
|**Multilevel regression and poststratification** *J Lopez-Martin, J H Phillips, A Gelman* -- Case studies of multilevel modeling and poststratification|`r ilink("tuto", "https://bookdown.org/jl5522/MRP-case-studies/", lvl=2)`|
...
| Name                                      | Links |
|-------------------------------------------|-------|
|**tidybayes** *M Kay* -- Integrate Bayesian modeling methods into a tidy data and ggplot workflow|`r ilink("tuto", "http://mjskay.github.io/tidybayes/", lvl=2)`|
