...
| Name                                      | Links |
|-------------------------------------------|-------|
|**Bayesian statistics with R** *O. Gimenez* -- A clear introduction to Bayesian Analysis using R and jags, including practical| `r ilink("course", "https://oliviergimenez.github.io/bayesian-stats-with-R/", lvl=1)`|
...
|**Learning Bayesian Statistics** -- a podcast channel presenting scientists, their approach and thinking in Bayesian statistics|`r ilink("site", "https://www.learnbayesstats.com/", lvl=2)`|
...
| Name                                      | Links |
|-------------------------------------------|-------|
|**Become a Bayesian with R & Stan** *M Clark* -- a basic introduction to the probabilistic programming language Stan|`r ilink("tuto", "http://m-clark.github.io/workshops/bayesian/index.html#home", lvl=1)`|
|**Stan for Ecology** -- location for all types of work in ecology that use the software Stan for Bayesian inference|`r ilink("site", "https://stanecology.github.io/")`|
...
| Name                                      | Links |
|-------------------------------------------|-------|
|**nimble-training** *C Paciorek, D Turek, P de Valpine* -- several workshops to learn programming with nimble|`r ilink("course", "https://mc-stan.org/docs/2_21/stan-users-guide/index.html")`|
