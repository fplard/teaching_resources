...
| Name                                      | Links |
|-------------------------------------------|-------|
|**Bayes Rules! An Introduction to Applied Bayesian Modeling** *A Jonhson et al.* -- To start Bayesian analyses gently |`r ilink("tuto", "https://www.bayesrulesbook.com/", lvl=1)`|
